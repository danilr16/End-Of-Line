...
public class TableCard extends BaseEntity{
    ...
    public static Map<Integer, List<nodeCoordinates>> homeNodes() {//Coordenadas de los nodos de inicio en función del número de jugadores en partida
        Map<Integer, List<nodeCoordinates>> mp = Map.of(1, List.of(nodeCoordinates.of(3, 3, 0)),
            2, List.of(nodeCoordinates.of(4, 3, 0), nodeCoordinates.of(4, 5, 0)),
            3, List.of(nodeCoordinates.of(4, 3, 3), nodeCoordinates.of(3, 4, 0), nodeCoordinates.of(4, 5, 1)),
            4, List.of(nodeCoordinates.of(4, 5, 0), nodeCoordinates.of(5, 4, 3), nodeCoordinates.of(6, 5, 2), 
                nodeCoordinates.of(5, 6, 1)),
            5, List.of(nodeCoordinates.of(3, 5, 0),nodeCoordinates.of(4, 4, 3),nodeCoordinates.of(6, 4, 3),
                nodeCoordinates.of(4, 6, 1),nodeCoordinates.of(6, 6, 1)),
